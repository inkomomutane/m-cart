    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Atualize as informações de perfil e o endereço de e-mail da sua
                conta.
            </p>
            <p
        ...
        <form
            ...
            class="mt-6 gap-4 grid grid-cols-1 md:grid-cols-2"
        >
            <div>
                <label
                    for="name"
            ...
            <div class="flex items-center gap-4">
                <button
                    ...
                    type="submit"
                    class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
                >
                    Save
                </button>
